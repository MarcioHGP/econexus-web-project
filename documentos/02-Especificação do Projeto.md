...
| RF-15 | cadastro de pontos de descarte                                      | Representante de Ponto de Descarte   | Cadastrar dados institucionais e geográficos                                      | Permitir visualização de pontos próximos                                                              | Rafael          | Cadastro               |
| RF-16 | reivindicação de itens para doação                                  | Usuário                              | Marcar item como reivindicado                                                     | Permitir que usuários reivindiquem itens                                                              | Rafael          | Fórum de post de itens |
